...
public final class ItemsRegister {
    ...
    public static void init() {
        GameRegistry.registerItem(
                ItemsRegister.sleepingBagItem = new ItemSleepingBag().setUnlocalizedName("sleepingBag")
                        .setCreativeTab(CreativeTabs.tabDecorations).setTextureName("sleepingbag:sleeping_bag")
                        .setMaxStackSize(1),
                "sleepingBag");
        GameRegistry.registerBlock(
                (Block) (ItemsRegister.sleepingBagBlock = (BlockSleepingBag) new BlockSleepingBag().setHardness(0.2f)
                        .setBlockName("sleepingBagBlock").setBlockTextureName("sleepingbag:sleeping_bag")),
                "sleepingBagBlock");
    }
}
